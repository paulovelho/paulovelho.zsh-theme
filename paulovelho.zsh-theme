...
setprompt () {
    ...
    for color in RED GREEN YELLOW BLACK BLUE MAGENTA CYAN WHITE GREY; do
...
$PR_GREEN%$PR_PWDLEN<...<%~%<<\
$PR_GREY)`rvm_prompt_info || rbenv_prompt_info`$PR_GREY$PR_HBAR$PR_HBAR${(e)PR_FILLBAR}$PR_HBAR$PR_GREY(\
...
($PR_YELLOW%D{%b %d - %H:%M:%S}$PR_GREY)$PR_HBAR$PR_LRCORNER$PR_NO_COLOUR'
